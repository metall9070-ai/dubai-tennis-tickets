      ...
      <main className="flex-1 pt-24 pb-20">
        <div className="max-w-[980px] mx-auto px-4 sm:px-6">
          ...
          <article className="prose prose-lg max-w-none text-[#1d1d1f]/90 leading-relaxed font-normal space-y-12">
            ...
            <section>
              <p className="mb-6">
                This Privacy Policy defines the procedures for collecting, using, storing, and protecting personal data of users and clients of the {config.brand} (WORLD TICKETS 365 INC) service (hereinafter referred to as "we", "our", or "us"). Users and clients are individuals who use the {siteUrl} website (hereinafter referred to as "you", "your", or the "Client").
              </p>
              <div className="bg-[#f5f5f7] p-8 rounded-[32px] border border-black/5 mb-8">
                <p className="text-[15px] font-semibold text-[var(--color-primary)] mb-0 italic">
                  {config.brand} (WORLD TICKETS 365 INC) operates as a secondary marketplace, providing services for the purchase, sale, and resale of tickets for various events. Ticket prices may exceed face value.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 pl-4 border-l-2 border-[var(--color-primary)]/20">
                ...
                <p>1.3. By using the services of {config.brand} (WORLD TICKETS 365 INC), the Client confirms consent to the processing of their personal data, as well as the data of third parties, in accordance with this Policy and applicable laws of the United States of America.</p>
            ...
            <section>
              ...
              <div className="space-y-4 pl-4 border-l-2 border-[var(--color-primary)]/20">
                ...
                <p>2.2. {config.brand} (WORLD TICKETS 365 INC) is not responsible for how third-party websites or services, links to which may appear on our website, process personal data.</p>
            ...
            <section>
              ...
              <div className="space-y-4 pl-4 border-l-2 border-[var(--color-primary)]/20">
                ...
                <p>4.8. Personal data may be disclosed to third parties in the following cases: to provide services to the Client; as required by U.S. law; in the event of business transfer or reorganization, provided this Policy is upheld; to protect the legal rights and interests of {config.brand} (WORLD TICKETS 365 INC); in anonymized form for analytical purposes.</p>
                <p>4.9. {config.brand} (WORLD TICKETS 365 INC) does not store, sell, transfer, or lease cardholder data.</p>
