 ...
 *   Secondary → #636366, font-medium  (time, venue, labels, month, weekday)
    ...
    >
      ...
      <div className="hidden lg:flex flex-row items-center p-0 h-[140px]">
        ...
        <div className="flex flex-col items-center justify-center min-w-[110px] h-full bg-[#f5f5f7] border-r border-black/5 group-hover:bg-[#eee] transition-colors duration-500">
          <span className="text-[11px] font-medium text-[#636366] uppercase tracking-wider leading-none">{dateInfo.month}</span>
        ...
        <div className="flex-grow flex flex-col gap-3 px-8">
          ...
          <div className="flex items-center gap-5">
            ...
            <span className="text-[10px] font-medium text-[#636366] uppercase tracking-wider">vs</span>
            <div className="flex items-center gap-3">
              <img
          ...
          <div className="flex items-center gap-5 text-[13px] font-medium text-[#636366]">
        ...
        <div className="flex items-center gap-6 px-8 border-l border-black/5 h-full">
          {!event.isSoldOut && hasValidPrice && (
            <>
              <div className="flex flex-col items-end">
                <span className="text-[10px] font-medium text-[#636366] uppercase tracking-wider">From</span>
          ...
          {event.isSoldOut && (
            <span className="px-6 py-3.5 bg-[#f5f5f7] text-[#636366] rounded-xl font-semibold text-[13px] uppercase tracking-wider">
              Sold Out
            </span>
          )}
        </div>
      ...
      <div className="lg:hidden p-5 flex flex-col gap-4">
        ...
        <div className="flex flex-col items-center gap-1.5 text-[13px] font-medium text-[#636366]">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5">
        ...
        <div className="flex flex-col items-center gap-3 pt-4 border-t border-black/5">
          {!event.isSoldOut && hasValidPrice && (
            <>
              <div className="flex items-baseline gap-1.5">
                <span className="text-[11px] font-medium text-[#636366] uppercase tracking-wider">From</span>
          ...
          {event.isSoldOut && (
            <span className="w-full py-3.5 bg-[#f5f5f7] text-[#636366] rounded-xl font-semibold text-[13px] uppercase tracking-wider text-center">
              Sold Out
            </span>
          )}
        </div>
