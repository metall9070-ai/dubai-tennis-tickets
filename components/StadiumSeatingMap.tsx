      ...
      >
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2 z-20">
          ...
          <button
            ...
            className="w-10 h-10 bg-white rounded-xl shadow-lg border border-black/5 flex items-center justify-center text-[11px] font-bold text-[#636366] hover:bg-[#f5f5f7] active:scale-95 transition-all"
          >
            {zoomPercent}%
          </button>
          <button
        ...
        {(!svgLoaded || !scaleReady) && (
          <div className="absolute inset-0 flex items-center justify-center bg-[#f8f9fb] z-30">
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-sm text-[#636366] font-medium">Loading seating map...</span>
            </div>
          </div>
        )}
      </div>
