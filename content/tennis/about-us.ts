...
const seo: SEOContent = {
  ...
  description:
    "Dubai Tennis Tickets is an independent ticket concierge service for Dubai Duty Free Tennis Championships. Secure booking and dedicated support.",
  h1: "About Us",
  breadcrumbLabel: "About Us",
  sections: [
    {
      heading: "About Dubai Tennis Tickets",
      body: `<p>Dubai Tennis Tickets is a professional ticket concierge service specializing in premium access to sports and entertainment events.</p>
...
<p>Dubai Tennis Tickets is focused on delivering a high-quality service experience, helping clients save time and confidently plan their visit to major events.</p>`,
    },
    {
      heading: "What We Do",
...
<p><strong>support@dubaitennistickets.com</strong></p>`,
    },
    {
