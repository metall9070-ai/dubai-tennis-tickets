...
const seo: SEOContent = {
  ...
  description:
    "Secure payment via Stripe with electronic ticket delivery for all Etihad Arena events. Multiple payment methods accepted.",
  h1: "Payment & Delivery",
  sections: [
    {
...
<p>If you do not receive a confirmation within 30 minutes, check your spam folder and contact <strong>support@yasarena.com</strong>.</p>`,
    },
    {
      heading: "Questions",
      body: `<p>For any questions about payment or delivery, contact our support team at <strong>support@yasarena.com</strong>. We are available to assist with all order-related inquiries.</p>`,
    },
  ],
}
