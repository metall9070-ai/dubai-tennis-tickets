...
<p>We implement industry-standard security measures to protect your personal information from unauthorized access, alteration, or disclosure.</p>`,
    ...
    {
      heading: "Your Rights",
      body: `<p>You have the right to access, correct, or request deletion of your personal data. To exercise these rights, contact us at <strong>support@yasarena.com</strong>.</p>`,
    },
    {
      heading: "Contact",
      body: `<p>For privacy-related inquiries, contact us at <strong>support@yasarena.com</strong>.</p>`,
    },
  ],
}
