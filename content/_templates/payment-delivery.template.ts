...
const seo: SEOContent = {
  ...
  description:
    "Secure payment via Stripe with electronic ticket delivery for all {brand} events. Multiple payment methods accepted.",
...
<p>1.2.2. To receive an invoice and coordinate payment terms the buyer must send the company's legal and banking details to the following email address: <strong>{email}</strong></p>
