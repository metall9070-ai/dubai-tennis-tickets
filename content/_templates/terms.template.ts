...
const seo: SEOContent = {
  ...
  description:
    "Review purchase terms, refund policy, and booking conditions for {brand}. Transparent terms, no hidden fees.",
  h1: "Terms of Service",
  ...
  sections: [
    ...
    },
    {
      ...
      body: `<p><strong>Offer / Terms</strong> — this public offer published by {brand} (WORLD TICKETS 365 INC) (hereinafter referred to as the "Agent"), addressed to any individual or legal entity for the conclusion of an agency services agreement under the terms set forth in this document.</p>
<p><strong>Website</strong> — the website located at https://{domain} and operated by the Agent.</p>
<p><strong>Agent</strong> — {brand} (WORLD TICKETS 365 INC), providing paid agency services related to searching, selecting, reserving, purchasing, and delivering tickets.</p>
