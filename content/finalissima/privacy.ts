...
<p><strong>Football Festival Qatar (WORLD TICKETS 365 INC) operates as a ticket concierge and ticket sourcing service through a network of suppliers and partners. Tickets may be obtained from official platforms or secondary market providers. Ticket prices may differ from the original face value.</strong></p>`,
    },
    {
      ...
      body: `<p>1.1. This Policy applies to all personal data provided by users when using the website, services, and other platforms of Football Festival Qatar (WORLD TICKETS 365 INC), including the purchase and processing of tickets for events organized by third parties.</p>
...
<p>1.3. By using the services of Football Festival Qatar (WORLD TICKETS 365 INC), the Client confirms consent to the processing of personal data in accordance with this Policy and applicable laws of the United States of America.</p>
...
<p>1.5. If the Client does not agree with any provisions of this Policy, they must refrain from using the website and services of Football Festival Qatar (WORLD TICKETS 365 INC).</p>`,
    },
    {
...
<p>2.2. Football Festival Qatar (WORLD TICKETS 365 INC) is not responsible for how third-party websites process personal data if links to such websites appear on our website.</p>
...
<li>complying with legal obligations</li>
    ...
    },
    {
      ...
      body: `<p>4.1. Football Festival Qatar (WORLD TICKETS 365 INC) processes personal data in accordance with U.S. law and applicable international standards.</p>
...
<p>4.9. Football Festival Qatar (WORLD TICKETS 365 INC) does not store, sell, or lease cardholder data.</p>
...
<p>Requests related to personal data processing can be sent to: <strong>support@footballfestivalqatar.com</strong></p>`,
    },
    {
...
<p>7.2. Football Festival Qatar (WORLD TICKETS 365 INC) is not responsible for data loss caused by the Client.</p>
