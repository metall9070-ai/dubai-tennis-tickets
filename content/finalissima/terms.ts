...
const seo: SEOContent = {
  title: "Terms of Service — Football Festival Qatar",
  description:
    "Review purchase terms, refund policy, and booking conditions for Football Festival Qatar. Transparent terms, no hidden fees.",
  h1: "Terms of Service",
  ...
  sections: [
    ...
    {
      heading: "1. Terms and Definitions",
      body: `<p><strong>Offer / Terms</strong> — this public offer published by Football Festival Qatar (WORLD TICKETS 365 INC) (hereinafter referred to as the "Agent"), addressed to any individual or legal entity for the conclusion of an agency services agreement under the terms set forth in this document.</p>
<p><strong>Website</strong> — the website located at https://footballfestivalqatar.com and operated by the Agent.</p>
<p><strong>Agent</strong> — Football Festival Qatar (WORLD TICKETS 365 INC), providing paid agency services related to searching, selecting, reserving, purchasing, and delivering tickets.</p>
...
<p><strong>Ticket Concierge Service</strong> — a service for sourcing and acquiring tickets through a network of partners and suppliers, including official ticket platforms and participants of the secondary ticket market.</p>`,
    },
    {
      ...
      body: `<p>2.1. These Terms govern the relationship between the Agent and the Client.</p>
...
<p>2.6. The Client understands and accepts that ticket prices may be above or below their original face value set by the event organizer.</p>`,
    },
    {
      ...
      body: `<p>3.1. At the Client's request, the Agent provides services related to searching, selecting, reserving, purchasing, and delivering tickets.</p>
...
<p>3.5. The Agent reserves the right to amend these Terms. The version of the Terms in effect at the time of order payment shall apply.</p>`,
    ...
    {
      heading: "4. Formation of the Agreement",
      body: `<p>4.1. The agreement is considered concluded at the moment the Client completes payment for the order.</p>
...
<p>4.3. By placing an order, the Client confirms that they have reviewed the ticket delivery conditions, refund rules, and the specifics of purchasing tickets on the secondary market.</p>`,
    ...
    {
      heading: "5. Service Performance",
      body: `<p>5.1. Orders are placed through the forms available on the Website.</p>
...
<p>5.6. The Agent may cancel an order and issue a refund in cases of suspected fraud or use of stolen payment data.</p>`,
    },
    {
      ...
      body: `<p>6.1. All prices are indicated in U.S. dollars or another currency specified on the Website.</p>
...
<p>6.4. The Client agrees that the order price may include service fees and the Agent's commission.</p>`,
    ...
    {
      heading: "7. Ticket Delivery",
      body: `<p>7.1. The delivery method depends on the ticket type.</p>
...
<p>7.3. The Agent is not responsible for delivery issues caused by incorrect Client data.</p>`,
    },
    {
      ...
      body: `<p>8.1. All sales are final.</p>
...
<p>8.6. The Agent is not responsible for decisions of the event organizer including cancellation, postponement, program changes, or changes in participating performers.</p>`,
    ...
    {
      heading: "9. Rights and Obligations of the Parties",
      body: `<p>9.1. The Agent has the right to: substitute tickets with equivalent or higher-category tickets; refuse service in cases of suspected fraud; rely on information provided by the event organizer.</p>
...
<p>9.3. The Client agrees to contact customer support before initiating any payment dispute or chargeback with their bank.</p>`,
    },
    {
      ...
      body: `<p>10.1. The Agent's liability is limited to the amount paid by the Client for the services.</p>
...
<p>10.3. The Agent is not liable for indirect losses including travel expenses, accommodation costs, or other related expenses.</p>`,
    },
    {
      ...
      body: `<p>The parties shall not be liable for failure to perform obligations caused by force majeure events.</p>`,
    },
    {
      heading: "12. Governing Law",
      body: `<p>12.1. These Terms are governed by applicable law.</p>
